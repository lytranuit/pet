...
class Category_menu extends BaseController
{
    ...
    { /////// trang ca nhan
        if (isset($_POST['dangtin'])) {
            ...
            return redirect()->to(base_url('admin/category_menu'));
        } else {
    ...
    public function table()
    {
        ...
        if (!empty($posts)) {
            foreach ($posts as $post) {
                ...
                $nestedData['action'] = '<a href="' . base_url("admin/category_menu/up/" . $post->id) . '" class="btn btn-primary btn-sm mr-2" data-type="confirm" title="Up to Top">'
                    . '<i class="fas fa-arrow-alt-circle-up"></i>'
                    . '</i>'
                    . '</a><a href="' . base_url("admin/category_menu/edit/" . $post->id) . '" class="btn btn-warning btn-sm mr-2" title="edit">'
                    . '<i class="fas fa-pencil-alt">'
                    . '</i>'
                    . '</a>'
                    . '<a href="' . base_url("admin/category_menu/remove/" . $post->id) . '" class="btn btn-danger btn-sm" data-type="confirm" title="remove">'
