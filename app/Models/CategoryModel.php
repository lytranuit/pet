...
class CategoryModel extends Model
{
    ...
    protected $allowedFields = ['slug', 'type', 'is_home', 'is_favorite', 'name_vi', 'name_en', 'name_jp', 'description_vi', 'description_en', 'description_jp', 'content_vi', 'content_en', 'content_jp', 'order', 'parent_id', 'active', 'image_url', 'date'];
